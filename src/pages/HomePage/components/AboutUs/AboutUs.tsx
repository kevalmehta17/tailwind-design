  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-full flex-col gap-[12px] pl-[5px] sm:gap-[18px] md:gap-[24px]">
        <span className="max-h-[52px] max-w-fit rounded-[4px] border border-black bg-[#f8f9fe] px-[12px] py-[6px] text-[12px] font-semibold leading-[18px] text-black sm:px-[20px] sm:py-[10px] sm:text-[16px] lg:px-[24px] lg:py-[12px] lg:text-[18px] lg:leading-[28px]">
          ABOUT US
        </span>
        ...
        <p className="max-w-fit text-[14px] font-normal leading-[22px] tracking-normal text-[#333333] lg:text-[16px] lg:leading-[24px]">
        ...
        <div className="mt-auto grid grid-cols-2 gap-[24px]">
          <div className="min-h-[142px] w-full rounded-[4px] bg-[#f5f5f5] p-[16px]">
            <h3 className="h-[28px] w-[70px] text-[24px] font-semibold text-[#333333]">
              178K+
            </h3>
            <p className="pt-[4px] text-[16px] font-normal leading-[24px] tracking-normal text-[#333333]">
        ...
        <div className="flex min-h-[145px] w-full items-center bg-[#f5f5f5]">
          <div className="flex-1">
            <h3 className="w-full pl-[24px] pt-[16px] text-[24px] font-semibold leading-[28px] tracking-normal text-[#333333]">
              Title
            </h3>
            <p className="pl-[24px] text-[16px] font-normal leading-[24px] tracking-normal text-[#333333]">
              Lorem ipsum dolor amet, consectetur adipiscing elit. Faucibus in
              libero.
            </p>
          </div>
