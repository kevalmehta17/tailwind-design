...
const Hero = () => {
  return (
    ...
    >
      {/* TOP HERO */}  
        <div
        className="flex flex-col justify-between rounded-[20px] bg-pink-50 bg-left-bottom bg-no-repeat md:flex-row md:pr-6 lg:pr-0 overflow-hidden"
      ...
      >
        ...
        {/* <div className="flex w-full flex-col items-left justify-center gap-10 px-1 py-[62px] sm:items-center sm:justify-center sm:px-10 sm:py-20 md:w-auto md:flex-1 md:max-w-[520px] md:items-start md:px-10 md:py-[72px] md:gap-7 xl:max-w-[570px] xl:gap-10 xl:py-[106.5px] xl:pl-[60px] xl:pr-0"> */}
          ...
          <div className="flex flex-col gap-[14px] ">
            <h1 className="flex flex-col  text-[57px] text-black sm:text-[52px] lg:text-[60px] ">
            ...
            <p className="lg:w-full md:text-center text-[18px] leading-[125%] text-gray-900 sm:text-[24px] text-left   lg:text-[30px] lg:leading-[120%] lg:tracking-[-0.01em]">
              Clean, effective, and cruelty-free skincare made to deliver
              visible results.
            </p>
          </div>
          <div className="flex max-w-[340px] items-center rounded-[70px] border border-solid border-black bg-black px-4 py-2 md:justify-around  mr-auto lg:ml-0 lg:max-w-[230px] lg:gap-0.5 lg:px-5 lg:py-2.5">
            <Button className="border-none w-[340px] md:w-[230px] bg-transparent text-white text-[24px] font-normal leading-[120%] tracking-[-0.01em] md:text-[30px] xl:text-[32px]">
              Shop Now
            </Button>
            <img
              src={arrowRight}
      ...
      {/* BOTTOM HERO */}
      <div className="flex flex-col py-[30px] px-[16px] bg-gray-200 md:py-[40px] md:px-[30px] xl:py-[40px] xl:px-[50px]">
        <h2 className="text-[24px] text-black leading-[100%] tracking-[-0.01em]  sm:text-[40px] xl:font-normal xl:text-[50px]">
        ...
        <div className="flex flex-col text-start gap-[24px] pt-[16px] sm:pt-[26px] md:pt-[32px] md:gap-[18px]  md:flex-row  xl:pt-[50px] xl:gap-[24px]">
          ...
          <div className="w-full flex flex-col gap-[11px] px-[5px] py-[5px] sm:gap-[16px] md:gap-[18px] md:w-1/2 xl:gap-[30px]">
            <h3 className="text-[20px] leading-[120%] tracking-[-0.01em] text-black font-normal sm:text-[26px] md:text-[24px] xl:text-[28px]">
              Struggling with acne issues?
            </h3>
            <p className="font-light leading-[150%] tracking-[-0.01em] text-black text-sm sm:text-[20px] md:text-[27px] ">
            ...
            <div className="flex flex-row items-center gap-[7px] border border-solid border-gray-400 rounded-[71px] w-fit mt-[18px] px-[15.5px] py-[7.5px] bg-white xl:px-[21px] xl:py-[10px] xl:mt-0 sm:mt-0 sm:px-[18.5px] sm:py-[8.5px] md:px-[16px] md:py-[8px]">
              <Button className="text-[20px]  text-black leading-[120%] tracking-[-0.01em] sm:text-[29px] md:text-[26px] ">
                Explore Our Range
              </Button>
              <img
                src={arrowRightBlack}
